...
ovs_sysconfdir(void)
{
    static struct directory d = { NULL, "E:\\AppData\\Local\\Temp", "OVS_SYSCONFDIR" };
    return get_dir(&d);
}
...
ovs_pkgdatadir(void)
{
    static struct directory d = { NULL, "E:\\AppData\\Local\\Temp", "OVS_PKGDATADIR" };
    return get_dir(&d);
}
...
ovs_rundir(void)
{
    static struct directory d = { NULL, "E:\\AppData\\Local\\Temp", "OVS_RUNDIR" };
    return get_dir(&d);
}
...
ovs_logdir(void)
{
    static struct directory d = { NULL, "E:\\AppData\\Local\\Temp", "OVS_LOGDIR" };
    return get_dir(&d);
}
...
ovs_bindir(void)
{
    static struct directory d = { NULL, "E:\\AppData\\Local\\Temp", "OVS_BINDIR" };
    return get_dir(&d);
}
